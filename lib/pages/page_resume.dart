          ...
          child: Column(
            ...
            children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        WidgetTextBox(
                          ...
                          'Tenho experiência em desenvolvimento de aplicativos para Android e iOS usando Flutter e Dart, incluindo design de interface de usuário e lançamento nas lojas de aplicativos.'.i18n,
                        ),
                        Visibility(
              ...
              WidgetTextBox(
                ...
                'Responsável pelo gerenciamento do setor de manutenção de módulos de automação residencial, também fiz parte do time que efetuava manutenção e montagem de placas de circuito eletrônico. - 02/05/2014 até 30/09/2014'.i18n,
              ),
              WidgetTextBox(
                'Estagiário de automação na Nova Tecnologia'.i18n,
                'Desenvolvimento de sistemas de controle e automação predial e de eficiência energética.  05/11/2012 até 25/10/2013.'.i18n,
              ),
              Text(
              ...
              WidgetTextBox(
                ...
                'IFSP Instituto Federal de Educação, Ciência e Tecnologia de São Paulo - 01/06/2009 a 28/08/2019'.i18n,
              ),
              WidgetTextBox(
              ...
              Text(
                'Certificado Profissional Google UX Design (Coursera - Nível 1 - Março de 2024)'.i18n,
                textAlign: TextAlign.justify,
              ),
              Text(
                'Flutter Provider Essential Course (Udemy - Março/Abril de 2024)'.i18n,
                textAlign: TextAlign.justify,
              ),
              const SizedBox(height: 20.0),
              Text(
              ...
              Text(
                'Plataformas: Flutter, Android, iOS, PlatformIO, Linux, Arduino'.i18n,
                textAlign: TextAlign.justify,
              ),
              Text(
