...
extension Localization on String {
  static final _t = Translations.byText("pt_br") +
      ...
      {
        "pt_br": "Oi, meu nome é Raul!",
        "en_us": "Hello, my name is Raul!",
      } +
      {
        "pt_br": "Sou desenvolvedor Flutter há 3 anos. Como sou formado em Engenharia de controle e automação, desenvolvo aplicativos para o setor industrial, trabalhando desde o início do conceito, definindo e criando interfaces e fluxos de usuário, fazendo testes, até a publicação.",
        "en_us": "I've been a Flutter developer for 3 years. As I have a degree in Control and Automation Engineering, I develop applications for the industrial sector, working from the beginning of the concept, defining and creating interfaces and user flows, testing, until publication.",
      } +
      {
        "pt_br": "Nascido e criado em São Paulo, adoro exercitar minha criatividade programando, criando interfaces, desenvolvendo dispositivos eletrônicos e fazendo música.",
        "en_us": "Born and raised in São Paulo, I love exercising my creativity by programming, creating interfaces, developing electronic devices and making music.",
      } +
      {
        "pt_br":
